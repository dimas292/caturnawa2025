...
export default function DCCInfografisFinalScoresPage() {
  ...
  const fetchScores = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/admin/dcc-infografis-final-scores')
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `dcc-infografis-final-scores-${new Date().toISOString().split('T')[0]}.csv`
    a.click()
  }
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <h1 className="text-3xl font-bold mb-2">Hasil Nilai DCC Infografis Final</h1>
          <p className="text-gray-600">Tabel penilaian peserta Digital Creative Competition Infografis - Tahap Final</p>
        </div>
      </div>
