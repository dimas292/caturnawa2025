// src/app/dashboard/admin/kdbi/pairing/page.tsx
"use client"
...
export default function KdbiPairingPage() {
  ...
  async function loadData() {
    setLoading(true)
    try {
      const res = await fetch(`/api/admin/kdbi/round-teams?stage=${stage}&round=${round}`)
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold">KDBI - Manual Pairing</h1>
