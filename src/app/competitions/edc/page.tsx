      ...
      <div className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-4xl font-bold">EDC</h1>
            <Badge className="bg-green-500">Debate</Badge>
          </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                English Debate Competition (EDC) is a prestigious debate competition conducted entirely in English. This competition is designed to enhance participants' critical thinking, argumentation skills, and public speaking abilities in an international context.
              </p>
              <p>
                EDC follows the British Parliamentary (BP) format with 4 teams in each debate room. Participants will debate on various contemporary issues relevant to both Indonesian and global contexts, all conducted in English.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Each debate room consists of 4 teams with 2 members per team:
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span>Proficient in English (speaking, listening, and comprehension)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Register now and showcase your English debating skills!
                </p>
