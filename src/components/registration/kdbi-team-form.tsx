...
export function KDBITeamForm({
  ...
  if (!selectedCompetition || selectedCompetition.type !== "KDBI") return null
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                <Label>Kelurahan/Kecamatan, Kabupaten, Kota *</Label>
                <Input
            ...
            <div className="mt-6 space-y-4">
              <h4 className="font-medium text-gray-700">Dokumen Wajib:</h4>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  {formData.members[0].ktm && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[0].ktm.name}</p>
                  )}
                </div>
                
                <div>
                  <Label>Pas Foto Formal Terbaru (3x4) *</Label>
                  <div className="mt-2">
                    <Input
                      type="file"
                      accept="image/*"
                  ...
                  {formData.members[0].photo && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[0].photo.name}</p>
                  )}
                </div>
                
                <div>
                  <Label>Bukti Screenshot Status Mahasiswa PDDikti *</Label>
                  <div className="mt-2">
                    <Input
                      type="file"
                      accept="image/*,.pdf"
                  ...
                  {formData.members[0].socialMediaProof && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[0].socialMediaProof.name}</p>
                  )}
                </div>
                
                <div>
                  <Label>Bukti Mengikuti Sosial Media UNAS FEST 2025 *</Label>
                  <div className="mt-2">
                    <Input
                      type="file"
                      accept="image/*,.pdf"
                  ...
                  {formData.members[0].twibbonProof && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[0].twibbonProof.name}</p>
                  )}
                  <p className="text-xs text-muted-foreground mt-1">TikTok, Youtube, Instagram</p>
                </div>
                
                <div>
                  <Label>Bukti Share Twibbon UNAS FEST 2025 *</Label>
                  <div className="mt-2">
                    <Input
                      type="file"
                      accept="image/*,.pdf"
                  ...
                  {formData.members[0].delegationLetter && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[0].delegationLetter.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {formData.members[0].khs && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[0].khs.name}</p>
                  )}
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  {formData.members[1].ktm && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].ktm.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {formData.members[1].photo && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].photo.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {formData.members[1].socialMediaProof && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].socialMediaProof.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {formData.members[1].twibbonProof && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].twibbonProof.name}</p>
                  )}
                  <p className="text-xs text-muted-foreground mt-1">TikTok, Youtube, Instagram</p>
                </div>
                ...
                <div>
                  ...
                  {formData.members[1].delegationLetter && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].delegationLetter.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {formData.members[1].khs && (
                    <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].khs.name}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h4 className="font-medium text-blue-800 mb-2">Dokumen Khusus untuk Debater 2:</h4>
              <div>
                <Label>Surat Pengantar Delegasi *</Label>
                <p className="text-sm text-blue-700 mb-2">
                  Surat dari masing-masing Universitas yang ditandatangani oleh Wakil Rektor, Dekan, atau Wakil Dekan
                </p>
                <div className="mt-2">
                  <Input
                    type="file"
                ...
                {formData.members[1].achievementsProof && (
                  <p className="text-sm text-green-600 mt-1">✓ File terupload: {formData.members[1].achievementsProof.name}</p>
                )}
              </div>
            </div>
          </CardContent>
